...
HD_PWD='C:/Projects/04-23-test/project_3/project_3.runs/design_1_c_accum_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_c_accum_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_c_accum_0_2.tcl
