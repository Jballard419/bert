...
HD_PWD='C:/Projects/New folder/640Mhz/project_3/project_3.runs/design_1_Header_failed_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Header_failed_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Header_failed_0_0.tcl
