...
# module references:
# Header_failed, address_counter, clock_change, clock_change, Buffer_help, b10_to_2b, os48_1011x20bTo10b_top2, oversample_8x, CDR_state_machine, FIFO_enabler, Head_state, address_counter_16, fifo_filled_lock, serial_pipeline_delay, error_valid, serial_pipeline_delay, serial_pipeline_delay, serial_pipeline_delay
...
proc create_hier_cell_hier_0 { parentCell nameHier } {
  ...
  connect_bd_net -net Head_state_0_Failed [get_bd_pins Failed] [get_bd_pins Head_state_0/Failed] [get_bd_pins util_vector_logic_1/Op1]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Header_failed_0, and set properties
  set block_name Header_failed
  set block_cell_name Header_failed_0
  if { [catch {set Header_failed_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Header_failed_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create port connections
  connect_bd_net -net Header_failed_0_dout [get_bd_pins Header_failed_0/dout] [get_bd_pins hier_1/gpio_io_i]
  ...
  connect_bd_net -net c_accum_0_Q [get_bd_pins Header_failed_0/din] [get_bd_pins c_accum_0/Q]
  connect_bd_net -net clk_wiz_0_blaze [get_bd_pins clk_wiz_0/blaze] [get_bd_pins hier_1/Clk]
  connect_bd_net -net clk_wiz_0_clkfb_out [get_bd_pins clk_wiz_0/clkfb_in] [get_bd_pins clk_wiz_0/clkfb_out]
  connect_bd_net -net clk_wiz_0_ctl [get_bd_pins New_cdr/ref_clk] [get_bd_pins clk_wiz_0/ctl]
  connect_bd_net -net clk_wiz_1_clk [get_bd_pins New_cdr/clk0] [get_bd_pins address_counter_1/clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins c_accum_0/CLK] [get_bd_pins clk_wiz_1/clk] [get_bd_pins clock_change_0/clk] [get_bd_pins clock_change_1/clk] [get_bd_pins hier_0/clk]
  ...
  connect_bd_net -net clk_wiz_1_second_clk [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_1/second_clk]
  ...
  connect_bd_net -net hier_0_Failed [get_bd_pins Header_failed_0/failed] [get_bd_pins hier_0/Failed]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins clk_wiz_1/reset] [get_bd_pins clock_change_0/rst] [get_bd_pins clock_change_1/rst] [get_bd_pins hier_1/ext_reset_in]
